...
def extract_initial_story(simulation, initial_stories):
    """
    ...
    Returns:
        str: The initial story for this simulation
    """
    story_key = simulation.get("story_key", "tariffs")
    return initial_stories.get(story_key, "")


def extract_facts(simulation, facts_library):
    """
    ...
    Returns:
        list: The facts for this simulation, split into individual items
    """
...
def calculate_bertscore(initial_story, final_story):
    """
...
def calculate_fact_presence(final_story, facts, model):
    """
    ...
    Returns:
        dict: Maximum similarity score for each fact and average fact presence
    """
...
def analyze_simulation(simulation, initial_stories, facts_library, model):
    """
...
def analyze_all_simulations(results_file, output_file=None):
    """
    ...
    Returns:
        list: The calculated metrics for all simulations
    """
...
def generate_summary_report(metrics, output_file=None):
    """
...
def visualize_metrics(metrics, output_dir=None):
    """
